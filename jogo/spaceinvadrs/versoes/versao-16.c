...
// Tiros inimigos que também possam destruir barreiras e atingir o jogador; tela de game over e tela inicial E DEIXAR ESSA BOMBA FLUIDA...
...
void velocidade_monstro(){
    ...
    printf("monstro %d", monstros_ativos);
